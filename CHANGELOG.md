...
- Fix any deprecations and prep for D12

9.2.2
--------------------------------------------------------------------------------
_Release Date: 2026-08-10_

- Removed patch for readonly_field_widget module.
...
- Move hooks from .module file into class based hooks.

8.7.0
--------------------------------------------------------------------------------
_Release Date: 2025-07-16_

- Update classes to work with migrate_tools > 6.1
